    ...
    <div data-aos="fade-up">
        ...
        <div class="mx-4 lg:mx-0">
            <div class="w-full px-8 pb-8 border-l border-b border-gray-400">
                ...
                <h2 class="font-bold text-md text-gray-100 text-left">Technical Lead</h2>
            </div>
        </div>
        <div class="mx-4 lg:mx-0">
            <div class="w-full px-8 pb-8 border-l border-b border-gray-400">
                <div class="w-full flex relative text-sm pb-2" style="right: 50px">
                    <span class="text-gray-100 bg-gray-900 border-2 border-blue-800 rounded-full px-2 mr-2">2022</span>
                    <span class="text-gray-400">BuildOnline</span>
                </div>
