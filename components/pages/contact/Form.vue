        ...
        <form @submit.prevent="handleSubmit">
            <div class="block lg:flex">
                ...
                <div class="w-full lg:w-1/2 pl-0 lg:pl-2 flex justify-center items-center">
                    <textarea v-model="form.message" v-validate="'required'" id="message" name="message" class="w-full p-4 mt-4 lg:mt-0 h-full bg-gray-850 text-gray-100 border-2 border-gray-700 rounded-lg" placeholder="Message"></textarea>
                </div>
