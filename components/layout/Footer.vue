<template>
    <footer class='w-full flex justify-center items-center border-t-2 border-gray-100 p-4 pin-b fixed bottom-0 h-16' style="background: white">
        <div class="block lg:flex justify-between text-gray-400 text-sm">
